            ...
            <div className='max-w-[1000px] w-[95%] h-[80vh] rounded-lg overflow-hidden shadow-xl grid grid-cols-1 md:grid-cols-2 border-2 border-[#b8dce8]'>
                ...
                <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }} className='right-panel flex items-center justify-center p-8 bg-white'>
                      <form action="" onSubmit={handleLogin} className='w-full max-w-[360px] flex flex-col gap-4' aria-label='Login form'>
                        <motion.div whileHover={{ scale: 1.02 }} className='w-full h-[48px] bg-white rounded-lg flex items-center justify-center gap-[10px] py-[8px] cursor-pointer border-2 border-[#b8dce8] hover:border-[#1488aa] transition-all shadow-sm hover:shadow-md'>
                        ...
                        <div className='relative'>
                              <input autoFocus id='login-email' name='email' autoComplete='email' type="email" className='w-full h-[48px] border-[2px] border-[#b8dce8] rounded-lg bg-[#f5f9fc] placeholder-[#5a8899] px-4 font-semibold text-[#0a5f7a] focus:outline-none focus:border-[#1488aa] focus:shadow-[0_0_20px_rgba(20,136,170,0.2)] transition-all' placeholder='Email' required  onChange={(e)=>setEmail(e.target.value)} value={email} aria-label='Email' />
                        </div>
                        ...
                        <button className='w-full h-[48px] bg-gradient-to-r from-[#1488aa] to-[#2d8a4d] rounded-lg flex items-center justify-center mt-2 text-[17px] font-semibold text-white hover:shadow-[0_0_20px_rgba(20,136,170,0.3)] transition-all'>{loading? <Loading/> : "Login"}</button>
